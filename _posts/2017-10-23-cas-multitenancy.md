...
```
...
cas.authn.jdbc.search[0].credential-criteria=.+@tenantA\.org
...
cas.authn.ldap[0].credential-criteria=.+@tenantB\.org
...
```
...
```
...
cas.authn.jdbc.search[0].principal-attribute-list=firstName,lastName
...
cas.authn.ldap[0].principal-attribute-list=cn,givenName
...
```
